...
def plot_roc_curve(filename, scores, labels, classes):
    lw = 1
...
def plot_precision_recall_curve(filename, scores, labels, classes):
    lw = 1
    ...
    lgd = plt.legend(loc='best')
    plt.savefig(filename + '_prec_recall.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.close()
...
def plot_roc_curve_multiclass(filename, scores, labels, classes):
    ...
    colors = cycle(['coral', 'mediumorchid', 'aqua', 'darkolivegreen', 'cornflowerblue', 'gold', 'pink', 'chocolate',
                    'brown', 'darkslategrey', 'tab:cyan', 'slateblue', 'yellow', 'palegreen', 'tan', 'silver'])
    ...
    plt.title('Receiver Operating Characteristic')
    lgd = plt.legend(loc='best')
    plt.savefig(filename + '_roc_all.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.close()
...
def plot_precision_recall_curve_multiclass(filename, scores, labels, classes):
    ...
    average_precision["micro"] = average_precision_score(labels, scores, average="micro")
    ...
    average_precision["macro"] = average_precision_score(labels, scores, average="macro")
    ...
    plt.title('Precision Recall Curve')
    lgd = plt.legend(loc='best')
    plt.savefig(filename + '_prec_recall_all.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.close()
